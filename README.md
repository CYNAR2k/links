...
- [ACTIVATE WINDOWS FOR FREE 1](https://github.com/kkkgo/KMS_VL_ALL)
- [ACTIVATE WINDOWS FOR FREE 2](https://github.com/massgravel/Microsoft-Activation-Scripts)
...
- [RUST DESK - Open source remote desktop](https://rustdesk.com/)
...
- [DMDE - Disk recovery utility](https://dmde.com/)
- [REG CONVERTER - Convert reg files to bat or vbs](https://www.sordum.org/8478/reg-converter-v1-2/)
- [OPEN RGB - lighting control that doesn't depend on manufacturer software](https://gitlab.com/CalcProgrammer1/OpenRGB)
- [MECH VIBES - Change the sound of your keyboard into anything](https://mechvibes.com/)
- [TERA COPY - Copy your files faster and more securely](https://www.codesector.com/teracopy)
- [DBAN - Free Open-Source Data Wiping](https://dban.org/)
- [USB TREE VIEW](https://www.uwe-sieber.de/usbtreeview_e.html)
- [SIMPLEWALL - Simple tool to configure Windows Filtering Platform which can configure network activity on your computer](https://github.com/henrypp/simplewall)
- [EZ UNLOCK - An open source alternative to and inspired by IOBit Unlocker](https://github.com/demberto/EzUnlock)
- [MIC SWITCH - Tool which allows you to mute/unmute using a predefined system-wide hotkey](https://github.com/iXab3r/MicSwitch)
...
- [TENFORUMS - Windows 10 related](https://www.tenforums.com/)
- [SEVEN FORUMS - Windows 7 related](https://www.sevenforums.com/)
...
- [PCPARTPICKER - Build your PC](https://pcpartpicker.com/)
- [REDDIT PC STUFF SALES](https://www.reddit.com/r/buildapcsales/)
- [EVERYNOISE - Find new music and artists](https://everynoise.com/)
- [ARCHIEVE - Library of millions of free books, movies, software, music, websites, and more](https://archive.org/)
...
- [TELL.WTF - Icons website](https://tell.wtf/)
- [TEST VSYNC](https://www.vsynctester.com/)
- [SHORTLYAI - AI Write texter](https://shortlyai.com/)
- [FIND MOVIES](https://agoodmovietowatch.com/)
- [TEST YOUR MONITOR](https://www.monitortests.com/)
- [ALTERNATIVE TO - Find alternative programs](https://alternativeto.net/)
- [SOURCEFORGE - Compare, Download & Develop Open Source & Business Software](https://sourceforge.net/)
...
- [TINYWOW - Convert Files](https://tinywow.com/)
- [LOFI GENERATOR](https://lofigenerator.com/) 
- [OVER API - Collectin all the cheat sheets](https://overapi.com/)
- [PRIVACY.SEXY - Web tool to generate scripts for enforcing privacy & security](https://privacy.sexy/)
